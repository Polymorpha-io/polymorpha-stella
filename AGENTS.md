...
| **G26** KnowledgeRecord boundary     | `KnowledgeRecord is semantic boundary` — providers `*KnowledgeProvider → KnowledgeRecord[]`                                                                                       | N/A                                                                                                                | Consumers `BrainService` never `VectorStore/clientStore/DatasetRepresentationService` directly                                                                         | Verifies boundary via `stella-notebook-pipeline.test.ts`                                                                      |
